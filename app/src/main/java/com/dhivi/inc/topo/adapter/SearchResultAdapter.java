...
public class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.ViewHolder> {
    ...
    public SearchResultAdapter(MyTopoListAdapter.OnItemSelectedListener notifier, ArrayList<Topos> savedToposList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.search_result_horizontal_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindContent(final int position) {
            ...
            if (topos != null) {
                ...
                Picasso.with(context).load(src).into(list_imageview);
