...
public class InstantToposAdapter extends RecyclerView.Adapter<InstantToposAdapter.ViewHolder> {
    ...
    public InstantToposAdapter(OnItemSelectedListener notifier,ArrayList<InstantTopos>instantTopos) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindContent(final int position) {
            ...
            final InstantTopos instantTopo = instantTopos.get(position);

            if(instantTopo!=null)
            {
                horizontal_textview.setText(instantTopo.getTopo_instant_name());
                title_textview.setText(instantTopo.getTopo_instant_name());
                desc_textview.setText(instantTopo.getTopo_instant_address());

                //String src = firsturl + instantTopo.getTopo_instant_lat()+","+instantTopo.getTopo_instant_lon() + secondurl + thirdurl;
                String src = String.format(context.getString(R.string.mapurl), instantTopo.getTopo_instant_user_id(),instantTopo.getTopo_img_url());
                Logger.i("","the image url:::"+src);
            ...
            total_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(instantTopo!=null)
                    {
                        notifier.onItemSelected(instantTopo);
                    }
                }
            });

            if(position==(instantTopos.size()-1))
            {
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(InstantTopos instantTopos);
    }
}
